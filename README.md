...
- Live: https://sjgant80-hub.github.io/fallsignal/
- Registry: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallsignal
- Publisher: [AI-Native Solutions](https://ai-nativesolutions.com)

## What this sovereign single-file browser tool does

fallsignal is a sovereign, MIT-licensed sovereign single-file browser tool in the AI-Native Solutions estate. It runs on your infrastructure, ships as source, and outlasts the vendor.

## Install

```
# Open https://sjgant80-hub.github.io/fallsignal/ in a modern browser
```
...
- Registry entry: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallsignal
